...
excerpt: To me, classic JRPGs are pure mechanisms, a kind of puzzle. Was there some way of getting the fun out of building such a mechanism—of solving that puzzle—, wrapping it with the minimal amount of functionality, the simplest thing that could possibly pass as a video game?
---
...
In retrospect, looking at tabletop RPGs felt backward because, by instead using the video games I already knew as models, I was benefiting from decades of RPG system simplifications---half the job had already been done.
