...
<Moriarty mentioned the Sleeping Beauty as a reference for the moode he wanted to strike in the game
...
<purcell previously worked in the cover art of the games
...
in the middle of the work for /Monkey Island/
# perhaps a scene where brian brings the box, and then indirect explanation of the earlier request
