...
One trick---a /hack/, programmers would say---he discovered early on was that, if he formed a checkerboard pattern of pixels, they would blend and bleed in the screen as he zoomed out, producing shades beyond those boring old 16 colors of the EGA palette. At first this is just an accidental observation, he doesn't make much of it. It's only when he starts working on a new batch of /Zak/ backgrounds, a section of the game that takes place in Mars, that he finds himself thinking again about those blended pixels. He realizes he can "weaponize" this artifact for artistic effect.

<The Martian landscapes are very provocative to Mark.
...
He settles quickly on the composition of the scene---a rocky horizon inspired by the Grand Canyon, sitting on top of a desert of fiery sand and a pale orange sun slightly removed from the center of the screen.

<it's the palette what gives him the most work,
a few attempts to settle on a rough plan, and then hours of trial-and-error to find the right color combinations and the right density of interleaved pixels for each figure and each boundary. he wants the image to jump out of the screen, he wants the sky, and the sun, and the ground to bleed into each other but remain distinct, he wants the sun to set the sky on fire and the earth to bed the ashes.

<and for the first time since started making digital illustrations
he feels he's tamed the material into speaking back to him
he's not constraints of the material don't constraint /him/, it's him that gets in control of the material, so much that the material in turns goes out of control, and rebels and autonomously produces something that wasn't part of Mark's plan

it's when the work starts speaking back to him that he acknowledges that his onto something. it may not be art, not yet, but it's better than anything he did and anything he's seen on a computer screen.
here's the spark, this is his direction, this is where he needs to go.

so he's careful not to let> Gary or the programmers see it before it's ready; he wants to set the stage and catch them off-guard.

<TODO: he sends takes it to the programmer, goes over to his desk to see their reaction and get some praise, he's expecting a pat on the back
...
# FIXME some for of this needs to be present, but it would be interesting to do it earlier. it could be separate from the indy section
...
The writing is on the wall. Once they lift the /Star Wars/ embargo, it's going to take a hell of an effort to prevent the suits from putting all hands on deck to milk Chewbacca.
