...
That part Mark already knows, he learned on his first week: LucasFilm games doesn't have the rights to make Games based on LucasFilm properties. That means no /Indiana Jones/, no /Star Wars/. Some toy company has the rights.
...
"Oh, so you meant /actual/ research." People in the Games Group use /research/ as keyword for blatantly not working. They ask /What are you researching/ to anyone they catch fooling around the office. "Well, I guess I can use some reference material myself".
...
There's a counter at the entry of the library. <TODO describe: spiral staircase leading to the 2nd floor and to Luca's office, stain glass dome
