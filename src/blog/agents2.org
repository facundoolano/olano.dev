...
*** Stack
I decided to use Django for this project, with some vanilla JavaScript for a few client-side features. Django was my bread and butter 10 years ago until I moved out of Python and web development. I forgot most of its details but I have a good idea of the concepts and the built-in components, and I felt that using it would safely get most of the web boilerplate out of the way.
