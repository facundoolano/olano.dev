...
In addition to the conversation context, Claude Pro has limits on how much you can consume per week and per session, which can be monitored at [[claude.ai/settings/usage][https://claude.ai/settings/usage]]:
