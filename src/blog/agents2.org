...
3. If the owner is interested in any of the other user's books, they get in touch to meet and make the trade. This exchange takes place outside of the application (there are no incentives to keep them in, and email or WhatsApp are more convenient for the users).
...
- *The human decides what and how to test*. I tried to test any relevant "business rule" through HTTP-level integration tests. I did let Claude write test code but providing step-by-step outlines (more on this below).
