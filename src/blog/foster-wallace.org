...
12.​ Como esto no es un ensayo sino un ejercicio anacrónico ---como esto es un blog en 2025 y en un blog no hay nada para perder--- el texto bien puede pasar sin una tesis. O podría improvisar una al final, en el último párrafo, una posdata antojadiza difícilmente emparentada con el texto que remata, accesible a unos pocos valientes, a los tercos perseverantes que aguanten <hasta el final>.
Si hubiera una tesis sería esta:
