...
date: 2025-10-11T10:00:00-03:00
layout: post
lang: en
tags: [software]
refs: [solvers, charity]
...
While ad hoc tests and probes lack the good reputation and protection against regressions of automated tests, I can't overstate how much value can be extracted from a few production checks, how many integration issues they catch, how much they contribute to a general sense of [[software-design-is-knowledge-building][confidence and ownership]] over a software system[fn:2].

*** Notes

[fn:1] This framing roughly maps to the [[https://rkoutnik.com/2016/04/21/implementers-solvers-and-finders.html][solutions implementer vs problem solver]] categorization.

[fn:2] This post was proofread by an LLM, I uploaded the full conversation [[verified-in-production-llm-proofread.txt][here]].
