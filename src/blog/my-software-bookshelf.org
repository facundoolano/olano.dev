...
[fn:25] Someone recently told me: "if you are not dealing with legacy systems at work, then you are building someone else's legacy system". This is an elegant way to capture the ideas in /Kill It With Fire/. We spend a disproportionate amount of time reading and writing books and blogs, and attending conferences, about greenfield system design, if we consider how much of our actual work is actually about maintaining old software---and how many greenfield projects never reach production. /Kill It With Fire/ didn't really work for me as a book: there's something missing in its organization, I often lost track of how I had gotten to a point in the discussion, or where it was leading me to. But its many insights and some brilliant passages keep coming back to me when I work and when I write. I think the ideas in this book hint at a more sustainable future for the software industry.

[fn:26] There used to be an assumption---there still is, really---that, after reaching the Senior title, engineers had to choose between settling there or jumping to a management role. This has terrible consequences, because people that don't like to manage or are bad at it, or just prefer a technical role, choose to manage because it seems their only option to grow professionally. (As a side note: stability instead of growth is always an option). The Staff engineer track at some organizations is the solution for that problem. Staff, Principal, and Distinguished engineers are technically-focused individual contributor roles, but with higher responsibilities and impact than Seniors. This doesn't mean they avoid people's problems and politics (we're in the human communication business, remember?),
it means acquiring organizational perspective and operating beyond the team level without having to manage other people. /The Staff Engineer's Path/ is a very stimulating read, making a great case for this track, with tools and career advice for those who want to pursue it. It's also a truly modern book, surveying the industry insights of the past decade and organizing them into a useful discussion.
