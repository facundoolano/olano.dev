...
Quién no se acuerda de aquellas joyitas noventosas para PC, mezcla de exploración pixelada con puzzles y choreo. Pero para que exista Monkey Island primero hizo falta un loco de las cuevas, una proto-internet anti soviética, el divorcio de Geroge Lucas y algunos accidentes empresariales.

-------

Will Crowther había estudiado física y a principios de los ‘70 trabajaba con computadoras. Trabajaba, específicamente, en ARPANET, un proyecto del Departamento de Defensa para desarrollar infraestructura de comunicaciones capaz de sobrevivir un bombardeo ruso. Por entonces conectada a unas pocas universidades y empresas de investigación, ARPANET derivaría, un par de ajustes geopolíticos más tarde, en lo que conocemos como internet.
...
Facundo Olano es ingeniero en informática y programador de software libre. En 2025 creó [[https://giralibros.com][giralibros.com]], una aplicación gratuita para cambiar libros en Buenos Aires. Escribe sobre software y ficción en [[https://olano.dev][olano.dev]].

Soy ingeniero en informática y programador de software libre. En 2025 publiqué giralibros.com, una app gratuita para cambiar libros en persona. Escribo sobre software y ficción en olano.dev
