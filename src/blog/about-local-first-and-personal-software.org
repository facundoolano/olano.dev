...
all times. Then another one in my TV and another in my reading device. I needed my programs to run on all these devices, and my data available and synchronized everywhere.

<[this is still the case.] When I look at the home screen on my phone, half of what I see are specialized data synchronization apps for my personal use: Google Drive, Google Keep, Trello, LastPass, Goodreads, Spotify.
<Some of these, like Google Docs and Trello, have collaboration features, but I don't typically use them in from my phone, I just need the data to be synced and available.
<the real-time collaboration typically happens in the desktop, in short lived sessions, so I don't mind having to use invasive applications for that.
