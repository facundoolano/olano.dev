...
- *Volatility*
- The higher the integration strength (the more knowledge shared across their boundaries), the higher the likelihood that modules will need to change in unison. Volatility represents how frequently they are anticipated to change. When such cascading changes occur, distance signifies the effort required to implement them.
- *Balance*
