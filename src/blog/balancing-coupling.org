...
- *Volatility* is a component's expected rate of change.
  ...
  - <Modularization (adjusting integration strength and distance to reduce maintenance cost) won't be as beneficial for components that are not expected to change frequently.
- *Balance*
