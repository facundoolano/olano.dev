...
<Splitting overcomplicated code into deep domain classes to be extensively unit tested, and wide controllers to be covered sparingly with integration tests.
