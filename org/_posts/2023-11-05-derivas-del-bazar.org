...
Cabría suponer que la crisis actual es la consecuencia necesaria del Gran Cisma entre el software libre y el open source. ¿Hubiera sido diferente la historia si los hackers se abroquelaban detrás del copyleft en vez de optar por el modelo permisivo y pro-negocios del open source?

# pasando en limpio
problemas del software libre
1. defensa intransigente de unos derechos que son irrelevantes para la mayoría de lo usuarios
2.
...
<previa a la computación personal, al software como bien de consumo, a la uniformización de los sistemas operativos (?
...
el argumento ético del software libre solo podría llegar a sostenerse en la actualidad como medio para obtener otras libertades, no por las libertades específicas por las que reclama
  ...
  - contrario a lo que decía fsf de free as in freedom, not beer, y la voluntad de negocio de oss, la gratuidad es el mejor selling point del software open source. -> suponer que el costo no importa es elitista, asume una abundancia que no es tal
  - me animo a decir que desde la perspectiva de los usuarios, nada es más importante que el hecho de que el software sea gratuito.
  - la gratuidad esquiva la escasez artificial, devuelve el software a su orden natural

- desde mi punto de vista, el problema de fondo es que tanto el software libre como el open source, en el apogeo de la cultura del regalo, constituyeron una forma de producción alternativa al mercado capitalista y, en última instancia, incompatible con él.
  - y como suele ser el caso con todo lo no-capitalista en un medio capitalista, el sistema tiende a absorberlo o extinguirlo
  - [TODO: considerar comprimir las proximas dos bullets en el final de la frase anterior y ya (sobre todo si la idea ya está relativamente cubierta en el párrafo anterior]
- el fsf se aferró intransigentemente a unas reglas que no eran adaptables al capitalismo pero <tampoco lo desafiaban abiertamente, no se constituía como un proyecto alternativo>. Ante todo, no tenían incentivos fuertes para sostenerse como sí tenía el OSS. así, se condenó al ostracismo.
- el oss, por su parte, pero terminó siendo absorbido y en última instancia desactivado por el capitalismo,
<el fs estaba condenado a extinguirse y el oss tenía todo para propagarse (en usuarios). ninguno de los dos cuenta con un sistema que favorezca su subsistencia
  - intuyo que la crisis actual del open source deriva de la pretensión (o la fuerza de gravedad (?)) de querer convertirlo en un negocio, a mayor o menor escala.
    - (tratar de sostener una cultura del regalo en medio de un mercado, sin construir la abundancia que la propiciaba
    - estaban dadas las condiciones para que se propague pero no para que sobreviva
