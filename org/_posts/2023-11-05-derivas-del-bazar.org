...
3. /Subestima la gratuidad del software/. Contrario a la famosa frase "free speech, not free beer" y a las intenciones de compatibilizarse con el mercado, tanto del software libre como del open source, creo que la gratuidad es un factor determinante, que puede no haber sido una motivación pero que explica su masificación. La razón por la que Linux es el sistema operativo predeterminado para casi cualquier uso o de que nadie dude en aprovechar los componentes abiertos al construir software es que no conllevan un costo económico. La gratuidad democratiza el acceso al software, acerca algo de esa abundancia que es requisito para su proliferación. Sin gratuidad no hay cultura del regalo, sin cultura del regalo no hay bazar, sin bazar no se puede competir técnicamente con el software privado.

El problema de fondo es que la cultura del regalo constituye una forma de producción alternativa al mercado capitalista y, en última instancia, incompatible con él. Y, como suele ser el caso con toda alternativa al capitalismo, el sistema tiende a absorberla o destruirla:
- El software libre ejercía un activismo intransigente, pero que se cuidaba de no extender su argumento más allá del software, por ejemplo para rechazando otras formas de escasez artificial y propiedad intelectual. Es decir, no pretendía enfrentar abiertamente al capitalismo pero tampoco se adaptaba al mercado, sino que pretendía que el mercado se adapte a él, por lo que virtualmente se extinguió ante las alternativas[fn:2].
