...
La postura intransigente del software libre es noble e inspiradora, pero en última instancia irrelevante y tanto o más elitista que la del open source:

1. /Sobrestima las libertad de modificar y redistribuir el código fuente/
2. /Subestima la gratuidad del software/
   sin gratuidad no hay cultura del regalo, sin cultura del regalo no hay bazar, sin bazar no se puede competir técnicamente con el software privado.
3. /Desestima las motivaciones por fuera de la ética/, que solo es un factor para una minoría de activistas previamente convencidos.
   (a diferencia de las motivaciones de las que habla linux, de la calidad técnica que busca el open source y de los beneficios del mercado capitalista)
...
# acaso por eso tuvo que venir alguien de afuera con un kernel para que el proyecto saliera de la oscuridad (?

# El problema de fondo, tanto para el software libre como para el open source, es que
La cultura del regalo del bazar constituye una forma de producción alternativa al mercado capitalista y, en última instancia, incompatible con él. Y, como suele ser el caso con toda alternativa al capitalismo, el sistema tiende a absorberla o destruirla:
...
- el open source adoptó una postura permisiva que allanó el camino para que se propague como virus pero a la vez lo dejó expuesto a ser cooptado y abusado por las corporaciones privadas.

Es curioso que, pese a evitar la ideología y a adoptar una postura explícitamente pro-mercado, el open source terminó de hecho siendo una contribución más valiosa a la mirada anticapitalista por el <ejemplo de calidad e incentivos no económicos que representó. En cualquier caso, ambos movimientos estaban condenados al fracaso porque su subsistencia requería unas condiciones de abundancia que no existen de hecho en el mercado capitalista, y que ninguno de los dos estaba diseñados para propiciar.
