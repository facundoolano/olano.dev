...
- el éxito técnico y de público de un proyecto open source está disociado de su sostenibilidad y de la remuneración a sus mantenedores
- la cantidad promedio de mantenedores de un proyecto open source es 1. proyectos <neurálgicos> como openssl sobrevive precariamente por un par de trabajadores voluntarios
- la producción de software open source pasó de ser un motivo de entretenimiento a una forma de autopromoción, una presión externa de crear un portfolio público con el que volverse más competitivo en el mercado laboral. (ya no hay bazaares, ahora hay kiosquitos).
...
- más allá de los problemas de sustentabilidad, todo esto implica que open source en tanto modelo de desarrollo decentralizado (por fuera de las corporaciones), perdió algunas de las ventajas técnicas que tenía a fines de los 90.
  - <lejos de la mezquindad noventosa de Microsoft que se plantaba como enemigo del open source, que Bill Gates percibía como una forma de comunismo, hoy las empresas Big Tech usan, contribuyen y hasta financian su producción.
    una forma de strategic openness / apertura estratégica: toman lo que les sirve del bazar y descatan lo demás.
    <porque es una forma de apalancarse en el trabajo de la comunidad: de aprovechar los contribuidores y los testers de la primera ley de Linus.
  - adoptaron las prácticas abiertas en sus métodos de desarrollo.
  ...
  - tienen, a su vez, recursos para organizar la producción de open source mejor que la que surge voluntariamente
